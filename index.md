...
<head>
    ...
    <style>
        ...
        /* NEW: Apple-Style Staggered Animation */
        .animate-scroll-reveal {
            opacity: 0;
            transform: translateY(30px) scale(0.98); /* Start slightly low and small */
            transition: opacity 1s cubic-bezier(0.25, 0.46, 0.45, 0.94), 
                        transform 1s cubic-bezier(0.25, 0.46, 0.45, 0.94);
        }
        .animate-scroll-reveal.is-visible {
            opacity: 1;
...
<body class="bg-white">
    ...
    <header class="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-lg rounded-b-xl">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <nav class="hidden md:flex space-x-8">
                    ...
                    <a href="#process" class="text-gray-600 hover:text-primary transition duration-150 font-medium">Our Process</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white shadow-xl">
            <nav class="pt-2 pb-3 space-y-1 px-2 sm:px-3">
                ...
                <a href="#process" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-bg-light hover:text-primary">Our Process</a>
        ...
        <section id="vision" class="py-16 md:py-24 bg-bg-light">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="mt-8 flex justify-center space-x-4">
                    <a href="#process" class="px-8 py-3 border border-transparent text-base font-medium rounded-full text-white bg-primary hover:bg-secondary md:py-4 md:text-lg md:px-10 shadow-lg transform hover:scale-[1.02] transition duration-300">
        ...
        <section id="process" class="py-16 md:py-24 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl sm:text-4xl font-bold text-center mb-12 text-gray-800">
                     Our Process: Closing the Loop on 3D Waste
                </h2>
                <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
                    
                    <div class="flex flex-col items-center p-6 rounded-xl shadow-lg border-t-4 border-primary/50 animate-scroll-reveal" data-delay="0">
                        <div class="p-3 inline-flex rounded-full bg-primary/10 text-primary mb-4">
                            <i data-lucide="package-open" class="w-8 h-8"></i>
                        </div>
                        <h3 class="text-xl font-bold mb-2 text-gray-700">1. Collection & Sorting</h3>
                        <p class="text-gray-500">
                            Gathering wasted 3D prints (failed prints, supports, prototyping waste) from users and 3D printing services, then sorting them by plastic type (PLA, PETG, ABS, etc.).
                        </p>
                    </div>

                    <div class="flex flex-col items-center p-6 rounded-xl shadow-lg border-t-4 border-primary/50 animate-scroll-reveal" data-delay="150">
                        <div class="p-3 inline-flex rounded-full bg-primary/10 text-primary mb-4">
                            <i data-lucide="settings" class="w-8 h-8"></i>
                        </div>
                        <h3 class="text-xl font-bold mb-2 text-gray-700">2. Shredding & Melting</h3>
                        <p class="text-gray-500">
                            The plastic waste is sterilized, shredded into pellets, and then melted down. Impurities are removed to ensure a clean, high-quality material base.
                        </p>
                    </div>

                    <div class="flex flex-col items-center p-6 rounded-xl shadow-lg border-t-4 border-primary/50 animate-scroll-reveal" data-delay="300">
                        <div class="p-3 inline-flex rounded-full bg-primary/10 text-primary mb-4">
                            <i data-lucide="refresh-cw" class="w-8 h-8"></i>
                        </div>
                        <h3 class="text-xl font-bold mb-2 text-gray-700">3. Extrusion & Re-Use</h3>
                        <p class="text-gray-500">
                            The melted material is extruded into new, recycled 3D printer filament or repurposed into other useful products, completing the circular lifecycle.
                        </p>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div class="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 transform hover:shadow-2xl hover:scale-[1.02] transition duration-300">
                        ...
                        <h3 class="text-xl font-bold mb-3 text-gray-800">Recycling the waste</h3>
                        <p class="text-gray-500">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                    ...
                    <div class="p-6 bg-white rounded-xl shadow-lg border border-primary/20">
                        ...
                        <p class="mt-2 text-lg font-medium text-gray-600">Expected amount of plastic items saved per person daily with our compaign</p>
                    </div>

                    <div class="p-6 bg-white rounded-xl shadow-lg border border-primary/20">
                        <p class="text-4xl sm:text-5xl font-extrabold text-primary" id="metric-waste">0</p>
                        <p class="mt-2 text-lg font-medium text-gray-600">Amount of plastic items wasted per person daily</p>
                    </div>

                    <div class="p-6 bg-white rounded-xl shadow-lg border border-primary/20">
                        <p class="text-4xl sm:text-5xl font-extrabold text-primary" id="metric-projects">0</p>
                        <p class="mt-2 text-lg font-medium text-gray-600">Expected amount of plastic items wasted per person daily after our compaign</p>
                    </div>
                </div>
    ...
    <script>
        ...
        // 3. Intersection Observer for Apple-style Staggered Scroll Animations
        const processCards = document.querySelectorAll('#process .animate-scroll-reveal');

        const observer = new IntersectionObserver((entries) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    // Get the delay from the data attribute (0, 150, 300ms)
                    const delay = parseInt(entry.target.getAttribute('data-delay') || '0', 10);
                    
                    // Use setTimeout to apply the 'is-visible' class after the delay
                    setTimeout(() => {
        ...
        // Delay the counter animation until after the page loads
